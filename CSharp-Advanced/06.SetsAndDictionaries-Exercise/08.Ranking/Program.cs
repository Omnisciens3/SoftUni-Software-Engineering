...
namespace _08.Ranking
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SortedDictionary<string, SortedDictionary<string, int>> usersSubmissions = new SortedDictionary<string, SortedDictionary<string, int>>();
            ...
            while (submissionInput != "end of submissions")
            {
                ...
                {
                    usersSubmissions.Add(username, new SortedDictionary<string, int>());
                }
            ...
            KeyValuePair<string, SortedDictionary<string, int>> bestCandidate =
